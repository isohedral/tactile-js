...
I will provide more complete documentation here in the near future.  In the meantime, it may be possible to understand the library by reading the source code, or the demo code in `demo.js`.
